...
@Component({
  selector: 'app-matketplace-item-decorative',
    imports: [
        AsyncPipe,
        DatePipe
    ],
  templateUrl: './matketplace-item-decorative.component.html',
  styleUrl: './matketplace-item-decorative.component.less'
})
export class MatketplaceItemDecorativeComponent {
	...
	togglePhone() {
		this.showPhone$.next(!this.showPhone$.getValue());
	}
